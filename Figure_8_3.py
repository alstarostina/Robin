...
max_beta_over_k = 5
min_beta_over_k = 0
betas_over_k = np.arange(number_of_tests) * (1 / (number_of_tests - 1)) * (max_beta_over_k - min_beta_over_k) + min_beta_over_k
